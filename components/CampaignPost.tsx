...
export function CampaignPost(props: CampaignPostProps) {
    ...
    const handleLikeSuccess = (pointsAwarded: number) => {
        Alert.alert("Success", `You have been awarded ${pointsAwarded} points for liking the post!`);
    };

    const handleShareSuccess = (pointsAwarded: number) => {
        Alert.alert("Success", `You have been awarded ${pointsAwarded} points for sharing the post!`);
    };
        ...
        <View style={[styles.container, { backgroundColor }]} className="nfc-campaign-post-item xs:w-[100vw] sm:w-[50vw] lg:w-1/4 w-full">
            ...
            <LinearGradient colors={["transparent", "rgba(0,0,0,0.8)"]} style={styles.gradient}>
                <View style={styles.contentWrapper}>
                    ...
                    <CampaignPostActions {...props} onLikeSuccess={handleLikeSuccess} onShareSuccess={handleShareSuccess} />
                </View>
            </LinearGradient>
        </View>
    );
