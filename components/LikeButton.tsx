...
export default function LikeButton({ postId, initialLikes, onLikeSuccess }: LikeButtonProps) {
    ...
    const handleLike = useCallback(
        debounce(async () => {
            ...
            try {
                ...
                const response = await axios.post(`${API_BASE_URL}/campaign-messages/${postId}/like`, {}, { headers: { Authorization: `Bearer ${token}` } });
                ...
                if (axios.isAxiosError(error)) {
                    ...
                    if (error.response?.status === 401) {
                        Alert.alert("Authentication Error", "Please log in again to like this post.");
    ...
    return (
        <TouchableOpacity style={styles.statItem} onPress={handleLike}>
            <Ionicons name={isLiked ? "heart" : "heart-outline"} size={20} color={isLiked ? "red" : iconColor} />
