    ...
    return (
        <ThemedView style={[styles.card, { backgroundColor: surfaceColor }]}>
            ...
            <Controller
                ...
                control={control}
                render={({ field }) => (
                    <Input label="Email" value={field.value} onChangeText={field.onChange} placeholder="Enter your email" keyboardType="email-address" />
                )}
            />
            ...
            <Controller
                ...
                control={control}
                render={({ field }) => (
                    <Input label="Phone" value={field.value} onChangeText={field.onChange} placeholder="Enter your phone number" keyboardType="phone-pad" />
                )}
            />
