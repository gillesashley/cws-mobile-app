...
export default function PointsPaymentScreen() {
    ...
    const { trigger, isMutating: isSubmitting, error: mxErrWithdrawal } = api.mxWithdrawals();
    ...
    const ListHeader = () => (
        <View>
            ...
            {!showWithdrawalForm && <Button title="Request Withdrawal" onPress={() => setShowWithdrawalForm(true)} style={styles.withdrawButton} />}
            {showWithdrawalForm && (
                <WithdrawalForm
