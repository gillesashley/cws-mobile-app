...
function isValidAnalyticsData(data: any): data is AnalyticsData {
    return (
        ...
        (typeof data.totalPoints === "number" || typeof data.totalPoints === "string") &&
        ...
        (data.popularPost.imageUrl === null || typeof data.popularPost.imageUrl === "string")
    );
}
...
function AnalyticsScreen() {
    ...
    const handleInfoPress = () => {
        Alert.alert("Analytics Info", "This screen shows your activity and engagement statistics. Swipe down to refresh the data.");
    };
    ...
    return (
        <SafeAreaView style={[styles.container, { backgroundColor }]} edges={["right", "bottom", "left"]}>
            <ScrollView>
                ...
                <ThemedView style={styles.content}>
                    <View style={styles.gridContainer}>
                        ...
                        <View style={styles.gridItem}>
                            <StatisticCard title="Total Likes" value={analyticsData.postLikes} change={analyticsData.postLikesChange} icon="heart" />
                        </View>
                        <View style={styles.gridItem}>
                            <StatisticCard title="Total Saved" value={analyticsData.postsRead} change={analyticsData.postsReadChange} icon="bookmark" />
                        </View>
                        <View style={styles.gridItem}>
                            <StatisticCard
                                title="Total Points"
                    ...
                    <UserActivityBreakdown postsShared={analyticsData.postsShared} postLikes={analyticsData.postLikes} postsRead={analyticsData.postsRead} />
                    <PopularPostCard
