...
export default function Login() {
    ...
    const { trigger: mxLogin, isMutating: isLoading, error } = useSWRMutation("/login", (_key, { arg }: { arg: Creds }) => login(arg.email, arg.password));
    ...
    const handleLogin = async (creds: Creds) => {
        ...
        mxLogin(creds)
            ...
            .catch((err: AxiosError) => [
                Alert.alert("Error", err?.message ?? "Login failed. Please check your credentials and try again."),
                console.log({ err }),
            ]);
    };
            ...
            <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={styles.keyboardAvoidingView}>
                <ScrollView contentContainerStyle={styles.scrollViewContent} keyboardShouldPersistTaps="handled">
                    ...
                    <View style={styles.formContainer}>
                        ...
                        <TouchableOpacity style={[styles.button, { backgroundColor: primaryColor }]} onPress={handleSubmit(handleLogin)} disabled={isLoading}>
